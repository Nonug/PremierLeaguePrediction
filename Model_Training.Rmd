...
p_load(
    ...
    doParallel, dplyr, CatEncoders, yardstick, kernlab
)
```
...
```{r}
create_report(train_df, y = "FTR", output_file = "train_report.html")
plot_bar(train_df)
```
### One-Hot Encoding
```{r}
...
lattice_save(xgboost_mod, "Model Accuracies with xgbLinear")
